...
class ExpediaAPIManager():
    ...
    def run(self, threads=None):
        self.logger.info('Running Expedia API importer')

        start_time = time.time()

        # Run logic here

        self.logger.info('Finished importing from expedia.com: {} sec'.format(time.time() - start_time))
    # }}}
